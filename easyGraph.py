...
class EasyGraph:
    ...
    def plot(self, title=' ', node_label = '', label = ' ', node_size_col=None, node_color_col=None, edge_color_col=None):
        ...
        self.node.set_hover_attribute(node_color_col, node_label)
